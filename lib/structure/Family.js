...
// ============================================================================================================================
    ...
    getChildrenInformation(){
        ...
        if(famNCHI){
            return {
                ...
                "parentInformation": this.extractFamilyEventDetail(famNCHI)?.parentInformation || "",
                "eventDetails": this.extractFamilyEventDetail(famNCHI)?.eventDetails || "",
            }
        }
    ...
    getFamilyResidence(){
        ...
        if(famResidence){
            return {
                "familyResidence": famResidence.lineVal || "",
                "type": famResidence.getSubstructuresByUri("g7:TYPE", false)[0]?.lineVal || "",
                "parentInformation": this.extractFamilyEventDetail(famResidence)?.parentInformation || "",
                "eventDetails": this.extractFamilyEventDetail(famResidence)?.eventDetails || "",
            }
        }
    ...
    getFamilyFacts(){
        ...
        if(famFacts.length !== 0){
            return {
                "numberOfFacts": famFacts.length,
                "facts": famFacts.map((fact) => {
                    ...
                    return {
                        "fact": fact.lineVal,
                        "type": type?.lineVal,
                        "parentInformation": familyEventDetail?.parentInformation || "",
                        "eventDetails": familyEventDetail?.eventDetails || "",
                    }
                })
            }
        }
...
// ============================================================================================================================
    ...
    getMarriageInformation(){
        ...
        return {
            "annulmentInformation": this.eventStructureToJson(annulments, "annulments") || "",
            "divorceInformation": this.eventStructureToJson(divorces, "divorces") || "",
            "divorceFilingInformation": this.eventStructureToJson(divorceFilings, "divorceFilings") || "",
            "engagementInformation": this.eventStructureToJson(engagements, "engagements") || "",
            "marriageBanInformation": this.eventStructureToJson(marriageBans, "marriageBans") || "",
            "marriageContractInformation": this.eventStructureToJson(marriageContracts, "marriageContracts") || "",
            "marriageLicenceInformation": this.eventStructureToJson(marriageLicences, "marriageLicences") || "",
            "marriagesInformation": this.eventStructureToJson(marriages, "marriages") || "",
            "marriageSettelmentInformation": this.eventStructureToJson(marriageSettelments, "marriageSettelments") || ""
        }
    }
...
// ============================================================================================================================
    ...
    getAssociatedIndividuals(){
        ...
        if(associatedIndividuals){
            return {
                "numberOfAssociatedIndividuals": associatedIndividuals.length,
                "associatedIndividuals": associatedIndividuals.map((asso) => this.extractAssociationStructure(asso))
            }
        }
    }
...
// ============================================================================================================================
    ...
    getSubmitter(){
        ...
        if(submitter){
            return {
                "numberOfSubmitter": submitter.length,
                "submitter": submitter.map(() => this.datasetReference?.getRecordByXref(submitter.lineVal))
            }
        }
    ...
    getChangeDate(){
        ...
        if(changeDateStructure){
            return {
                "changeDate": changeDateStructure.getSubstructuresByUri("g7:DATE-exact", false)[0]?.lineVal || "",
                "time": changeDateStructure.getSubstructuresByUri("g7:DATE-exact", false)[0]?.getSubstructuresByUri("g7:TIME", false)[0].lineVal || "",
                "note": this.extractNoteStructures(changeDateStructure) || ""
            }
        }
    ...
    getCreationDate(){
        ...
        if(creationDateStructure){
            return {
                "creationDate": creationDateStructure.getSubstructuresByUri("g7:DATE-exact", false)[0]?.lineVal || "",
                "time": creationDateStructure.getSubstructuresByUri("g7:DATE-exact", false)[0]?.getSubstructuresByUri("g7:TIME", false)[0].lineVal || ""
            }
        }
...
// ============================================================================================================================
    ...
    eventStructureToJson(structArray, propertyName){
        if(structArray.length !== 0){
            ...
            json[`numberOf${propertyName.charAt(0).toUpperCase() + propertyName.slice(1)}`] = structArray.length;

            // convert event information to JSON
            json[propertyName] = structArray.map((struct) => {
