...
module.exports = class GedcomDate extends Structure {
    ...
    handleDateValue() {
        ...
        let line = this.extractCalendarAndEpoch();
    ...
    extractCalendarAndEpoch() {
        const calendarTags = Object.keys(calendarDescriptions);
        const calendarTagExists = calendarTags.some(el => this.lineVal.includes(el));
        const epochTagExists = this.lineVal.includes("BCE");
