...
module.exports = class Structure {
    ...
    addSubstructure(structureParameters) {
        const structure = this.createStructureFromStructureParameters(structureParameters, (parseInt(this.level) + 1).toString());
        ...
        try{
            ...
            // this.datasetReference.removeStructure
            throw e;
        }
    }
    ...
    createStructureFromStructureParameters(structureParameters, level){
        ...
        structure["line"] = {
            ...
            EOL: this.datasetReference.getEOL()
        };
