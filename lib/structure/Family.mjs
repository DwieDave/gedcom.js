...
export class Family extends Structure  {
    ...
    checkSyntax(){
        ...
        // Husband
        for(const sub of this.substructures){
            if(sub.tag == GedcomTags.HUSBAND) current.push(sub);
        }

        if(current.length > 1) throw new GedcomSyntaxError("Cardinality Error: multiple HUSB in one FAM record are not allowed!");
