module.exports = {
    ...
    gedcomEnumTypes: {
        ...
        //g7_enumset_EVEN
        //g7_enumset_EVENATTR
        g7_enumset_MEDI: ["AUDIO", "BOOk", "CARD", "ELECTRONIC", "FICHE", "FILM", "MAGAZINE", "MANUSKRIPT", "MAP", "NEWSPAPER", "PHOTO", "TOMBSTONE", "VIDEO", "OTHER"],     
        g7_enumset_PEDI: ["ADOPTED", "BIRTH", "FOSTER", "SEALING", "OTHER"],  
        g7_enumset_QUAY: ["0", "1", "2", "3"],
        g7_enumset_RESN: ["CONFIDENTIAL", "LOCKED", "PRIVACY"],     
        g7_enumset_ROLE: ["CHIL", "CLERGY", "FATH", "FRIEND", "GODP", "HUSB", "MOTH", "MULTIPLE", "NGHBR", "OFFICIATOR", "SPOU", "WIFE", "WITN", "OTHER"],      
