...
class GrammarGenerator {
  ...
  constructor (path, nearleyHeader) {
    ...
    this.dataset = require('./grammarDefinition/DatasetGrammar.js');
    ...
    this.substructures = require('./grammarDefinition/Substructures.js');
    ...
    this.structureTypes = require('./grammarDefinition/StructureTypes.js');
