...
async function main() {
    ...
    // parse gedcom-file
    console.log("\nPARSE GEDCOM-FILE:");
    const dataset = await gedcomParser.parseGedFile("test/sampleData/ExampleFamilySearchGEDCOMFiles/remarriage1.ged");
    console.log(dataset.toString())
    const fam = dataset.getRecordByXref("F1");
    const husb = fam.getSubstructuresByTag("HUSB")[0];
    console.log(dataset.getRecordByXref(husb.lineVal))
