...
async function main() {
    ...
    // const gedcomString = await readGedFile("test/sampleData/ExampleFamilySearchGEDCOMFiles/minimal70.ged");
    const gedcomString = await readGedFile("test/sampleData/ExampleFamilySearchGEDCOMFiles/maximal70_without_extensions.ged");

    //testNearleyParser("0 HEAD\n1 GEDC\n2 VERS 7.0\n0 @F1@ FAM\n0 TRLR\n");
    testNearleyParser(gedcomString);
    const d = Dataset.createEmptyDataset("7.0")
...
function testNearleyParser(gedcomString){
    ...
    const family = dataset.getRecordByXref("F1")
