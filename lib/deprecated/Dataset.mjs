...
import { writeGedFile } from "./deprecated/writeGedFile.mjs";
import { Family } from "./deprecated/Family.mjs";
import { Individual } from "./deprecated/Individual.mjs";
import { GedcomSyntaxError } from "./deprecated/Syntax.mjs";
...
export class Dataset {
    ...
    async write(path) {
        writeGedFile(path, this.toString());
    }
}