  ...
  createStructure: (options) => {
    ...
    switch (type) {
      ...
      case lineTypes.SUBM_RECORD:
        ...
        lineObject = { level: line[0], xref: line[2].replaceAll('@', ''), tag: line[4], lineVal: '', EOL: line[5] };
        break;
      ...
      default:
        // Remove @-sign from beginning and end of XREF
        lineObject = { level: line[0], xref: line[2].replaceAll('@', ''), tag: line[4], lineVal: line[5], EOL: line[6] };
    }
