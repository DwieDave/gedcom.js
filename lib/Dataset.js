...
module.exports = class Dataset {
    ...
    createStructure(parsedObject, superstruct, associatedRecord){
        ...
        struct.setAssociatedRecord(associatedRecord)
        ...
        for(const sub of substructs){
            ...
            if(associatedRecord){
                struct.addSubstructure(this.createStructure(sub, struct, associatedRecord));
            }else{
                struct.addSubstructure(this.createStructure(sub, struct, struct));
            }
