...
module.exports = class Dataset {
    constructor(parsedHeader, parsedRecords, parsedTrlr, BOMset) {
        ...
        */
        ...
        if(parsedHeader && parsedTrlr){
            this.header = this.createStructure(parsedHeader, null);
            this.trlr = this.createStructure(parsedTrlr, null);
        }else{
        ...
        this.records = parsedRecords.map(r => this.createStructure(r, null));
    ...
    createStructure(parsedObject, superstruct){
        ...
        for(const sub of substructs){
            struct.addSubstructure(this.createStructure(sub, struct));
        }
