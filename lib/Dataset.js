...
module.exports = class Dataset {
    ...
    createStructure(parsedObject, superstruct, associatedRecord, addStructureFlag=false){
        ...
        switch(structureType){
            ...
            case lineTypes.HEADER:
                struct = new Structure.Header(line.level, line.xref, line.tag, line.lineVal, lineValType, line.EOL, [], this);
                break;

            // Family Record
            case lineTypes.FAM_RECORD:
                struct = new Structure.Family(line.level, line.xref, line.tag, line.lineVal, lineValType, line.EOL, [], this);
                break;

            // Individual Record
            case lineTypes.INDI_RECORD:
                struct = new Structure.Individual(line.level, line.xref, line.tag, line.lineVal, lineValType, line.EOL, [], this);
                break;
            
            // Multimedia Record
            case lineTypes.OBJE_RECORD:
                struct = new Structure.Multimedia(line.level, line.xref, line.tag, line.lineVal, lineValType, line.EOL, [], this);
                break;

            // Repository Record
            case lineTypes.REPO_RECORD:
                struct = new Structure.Repository(line.level, line.xref, line.tag, line.lineVal, lineValType, line.EOL, [], this);
                break;

            // SharedNote Record
            case lineTypes.SNOTE_RECORD:
                struct = new Structure.SharedNote(line.level, line.xref, line.tag, line.lineVal, lineValType, line.EOL, [], this);
                break;
            
            // Source Record
            case lineTypes.SOUR_RECORD:
                struct = new Structure.Source(line.level, line.xref, line.tag, line.lineVal, lineValType, line.EOL, [], this);
                break;
            
            // Submitter Record
            case lineTypes.SUBM_RECORD:
                struct = new Structure.Submitter(line.level, line.xref, line.tag, line.lineVal, lineValType, line.EOL, [], this);
                break;
            ...
            default:
                ...
                if(lineValType === dataTypes.ListText || lineValType === dataTypes.ListEnum){
                    ...
                    struct = new Structure.Structure(line.level, line.xref, line.tag, lineVal, lineValType, line.EOL, [], this);

                }else if(lineValType === dataTypes.Xref){
                    struct = new Structure.Structure(line.level, line.xref, line.tag, line.lineVal, lineValType, line.EOL, [], this);
    ...
    addStructure(struct, superstruct, associatedRecord){
        if(!struct.line.EOL){
            struct.line.EOL = this.getEOL();
        }
        this.createStructure(struct, superstruct, associatedRecord, true);
    }
