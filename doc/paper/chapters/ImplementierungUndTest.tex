...
Beim Initialisieren der \textsc{GedcomDate}-Klasse wird das GEDCOM konforme Date, mit Hilfe der Date-Bilbliothek
\textit{date-fns}, in ein JavaScript-Date-Objekt umgewandelt.
