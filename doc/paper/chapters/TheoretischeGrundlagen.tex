...
modular aufgebaut, so dass Benutzer ihre eigenen Parser und Lexer definieren und Parser aus BNF- und EBNF-Grammatiken erzeugen können. 
...
der ausgeführt wird, wenn bestimmte Teile der Eingabe erkannt werden. 
...
Der Algorithmus von Earley ist ein Parsing-Algorithmus, der kontextfreie Grammatiken parsen kann. Er wurde 1970 von Jay Earley entwickelt und
ist ein Bottom-Up-Parser, der die Eingabe von hinten nach vorne verarbeitet. Der Algorithmus von Earley ist ein Algorithmus der Typ-2-Chomsky-Hierarchie,
der kontextfreie Grammatiken mit mehrdeutigen und rekursiven Regeln parsen kann. 
...
darzustellen. Die EBNF ist eine Erweiterung der Backus-Naur-Form (BNF), die ursprünglich für die Programmiersprache Pascal entwickelt wurde. 
Sie erlaubt es, komplexe Syntax-Regeln in einer leichter verständlichen und kompakteren Schreibweise auszudrücken, indem sie zusätzliche Symbole
